...
public class Button extends BasicButton implements IButton {
    ...
    public boolean isHover(){
        return (super.getButtonOffX() <= super.getKernel().getInput().getMouseX()
                && (super.getButtonOffX()+super.getButtonW()) >= super.getKernel().getInput().getMouseX()
                && super.getButtonOffY() <= super.getKernel().getInput().getMouseY()
                && (super.getButtonOffY() + super.getButtonH() >= super.getKernel().getInput().getMouseY()));
    }
